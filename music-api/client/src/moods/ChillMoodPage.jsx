...
import "./CalmMood.css"; // Reuse existing styles
...
const ChillMoodPage = () => {
  ...
  useEffect(() => {
    const fetchChillMood = async () => {
      try {
        ...
        const chillMood = moods.find((m) => m.name.toLowerCase() === "chill");
        ...
        console.error("Error fetching chill mood:", err);
  ...
  // Fetch songs when Chill mood is available
  useEffect(() => {
    if (!mood) return;
    ...
    const fetchSongs = async () => {
      try {
        ...
        console.error("Error fetching chill songs:", err);
