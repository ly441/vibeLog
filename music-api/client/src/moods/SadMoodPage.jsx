...
import "./CalmMood.css"; // Reuse shared styles
  ...
  useEffect(() => {
    const fetchMood = async () => {
      try {
        ...
        const sad = moods.find((m) => m.name.toLowerCase() === "sad");

        if (sad) {
          setMood(sad);
        } else {
          setError("Sad mood not found.");
        }
      } catch (err) {
